 ...
 */
define('ENVO_ECOMMERCE_VERSION', '1.0.11');
...
if (class_exists('WooCommerce')) {
    ...
    if (!function_exists('envo_ecommerce_cart_link')) {
        ...
        function envo_ecommerce_cart_link() {
            ?>	
            <a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_html_e('View your shopping cart', 'envo-ecommerce'); ?>">
